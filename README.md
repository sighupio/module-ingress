...
| [cert-manager](katalog/cert-manager)          | `v1.21.2`            | cert-manager is a Kubernetes add-on to automate the management and issuance of TLS certificates from various issuing sources. |
